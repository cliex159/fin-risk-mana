...
```
#> [1]  0.123033744  0.005668913 -0.030938984
```
Since $skewness=0.12$ approximately equal $0$, the distribution is not skew and $mean=0.01$ approximately equal $median=-0.03$.
...
```
#> [1] -0.220824355 -0.002900342  0.014011103
```
Since $skewness=-0.22$ approximately equal $0$, the distribution is not skew and $mean=0$ approximately equal $median=0.01$.
