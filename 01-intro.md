...
#> [1]  0.004713217 -0.004753715 -0.013061950
```
Since $skewness=0$ approximately equal $0$, the distribution is not skew and $mean=0$ approximately equal $median=-0.01$.
...
#> [1] -0.03828174  0.02708302  0.03488448
```
Since $skewness=-0.04$ approximately equal $0$, the distribution is not skew and $mean=0.03$ approximately equal $median=0.03$.
...
#> [1]  1.05909764 -0.02731798 -0.29903706
```
Since $skewness=1.06$ is greater than $0$, the distribution is right-skew and $mean=-0.03$ is greater than $median=-0.3$.
...
#> [1] -0.62515847 -0.06921504  0.07799349
```
Since $skewness=-0.63$ is less than $0$, the distribution is left-skew and $mean=-0.07$ is less than $median=0.08$.
...
head(eurusd_logret)
#> [1]  0.0091324836 -0.0005786798  0.0103653445 -0.0001636929
#> [5]  0.0074210330  0.0008933285
```
...
#> 1 01/03/1985 165.37 166.11 164.38 164.57  88880000
#> 2 01/04/1985 164.55 164.55 163.36 163.68  77480000
#> 3 01/07/1985 163.68 164.71 163.68 164.24  86190000
#> 4 01/08/1985 164.24 164.59 163.91 163.99  92110000
#> 5 01/09/1985 163.99 165.57 163.99 165.18  99230000
#> 6  1/10/1985 165.18 168.31 164.99 168.31 124700000
#>   Adj.Close
#> 1    164.57
#> 2    163.68
#> 3    164.24
...
head(sp500_logret)
#> [1] -0.005422709  0.003415471 -0.001523322  0.007230338
